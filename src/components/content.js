...
class Content extends Component {
    constructor(){
        super();
        this.count = 1;
        this.maxLabelNumber = 16;
    }

    renderLabel(data){
        if(this.count > this.maxLabelNumber){
            this.count = 1;
        }
        return [
